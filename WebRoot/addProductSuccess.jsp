...
#footer {
  ...
  <div id="section">
    ...
    <br/>
    <br/>
    <div align="center"><h1><font color="#0000ff"><b>添加产品记录成功</b></font> </h1>
    <br/><br/>
    <a href="index.jsp"><font color="#000000"><b>返回首页</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="addPart.jsp"><font color="#000000"><b>继续添加零件记录</b></font></a></div>
 </div>
  <div id="footer">
    大众汽车数字化管理系统
  </div>
